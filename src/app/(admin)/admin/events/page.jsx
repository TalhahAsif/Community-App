          ...
          {EventArr.map((event) => {
            return (
              <TableRow key={event.id}>
                ...
                <TableCell className="text-center">{event.Category}</TableCell>
                <TableCell className="text-center">{event.location}</TableCell>
                <TableCell className="text-center">
                  {event.subcatogory}
                </TableCell>
                <TableCell className="text-center">{event.createdBy}</TableCell>
                <TableCell className="text-center">{event.createdAt}</TableCell>
              </TableRow>
            );
          })}
        </TableBody>
